...
In summary, these studies suggest that illusions, rather than being mere perceptual artifacts, engage specific neurocognitive processes involved in important higher order functions and neuropsychiatric disorders. **[ADD ONE/TWO SENTENCES MENTIONING THE PREDICTIVE CODING EXPLANATION (e.g., in notredame's review)]** However, the lack of consistency and replicability in the experimental designs using illusions-based stimuli appears as one of the main issue slowing the progress in the field.

...
...
Studies have shown that differences in stimulus features have systematic effects on the perceived illusion. For instance, simple manipulations such as inverting the orientation of the illusion (by 180 degrees) can influence perceptions of the Contrast and Ponzo illusion where in both cases, illusion magnitude is greater when the illusion presentation is in their upright conditions [@poom2020influences]. For the Ponzo illusion, this may be explained by the higher familiarity with ground planes like roads and railways receding in the distance (rather than towards us).
...

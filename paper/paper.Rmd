...
Finally, we hope that with *Pyllusion*, researchers are one step closer to establishing a validated paradigm for assessing visual illusion sensitivity. The ultimate goal is to facilitate the creation of studies that would investigate how, for each illusion, the modulation of the parameters affect behavioural responses, conscious perception, and the associated neural underpinnings. This would in turn allow for a better understanding of the commonalities and differences between these fascinating stimuli, and in particular, how their defining features invoke differential effects of illusory perception (or nonperception) across different populations. With this, psychology researchers can look forward to an accelerated progress in elucidating the neuropsychological mechanisms underlying psychopathogical conditions with distinct perceptual anomalies. As such, we hope that our tool contributes to the development of a strong axis that will unite the community working with illusions to push the field forward.

...
A fundamental problem for illusion research is that it lacks an objective, quantitative method to operationalize and measure illusion strength in experiments, relying on participants' subjective ratings on the perceived illusion.
...
Studies have shown that differences in stimulus features have systematic effects on the perceived illusion. For instance, simple manipulations such as inverting the orientation of the illusion (by 180 degrees) can influence perceptions of the Contrast and Ponzo illusion where in both cases, illusion magnitude is greater when the illusion presentation is in their upright conditions [@poom2020influences]. For the Ponzo illusion, this may be explained by the higher familiarity with ground planes like roads and railways receding in the distance (rather than towards us). Other features of the Ponzo illusion have also been shown to affect illusion strength, namely, lightness contrast and length of the wedge lines. Specifically, wedges of intermediate lengths (as compared to shorter and longer wedges) invoked the greatest illusion magnitude and increasing the lightness contrast of the wedges relative to the enclosed horizontal target lines increased Ponzo illusion magnitude [@jaeger1980effect]. Similar patterns have been reported for the Müller-Lyer illusion, where wings (or fins) of intermediate lengths and of greatest contrast relative to the horizontal shafts resulted in a greater tendency to overestimate the shaft lengths [@wickelgren1965brightness; @jaeger1975effect; @restle1977size]. Additionally, experiments manipulating the wing displacement (relative to the shaft) in the Müller-Lyer illusion also revealed that increasing angles (of the wings deflected away) to 160 degrees enhances illusion strength [@restle1977size]. 

The effects of these parametric properties are especially important in illusions used to inform promising applications, such as the Delbeouf illusion, which is often  referenced in studies of dieting and perceived food portions [e.g., @van2012plate; @mcclain2014visual]. The Delboeuf illusion varies according to how its central parametric properties like proximity and color contrast are manipulated. Specifically, the target (inner) circle appears larger than it actually is when the concentric circles are greater in color contrast [@oyama1962effect; @weintraub1972coming] and closer in proximity [@girgus1982assimilation; @surkys2006delboeuf; @jaeger2007effects]. This effect of distance between surrounding and target circles is also observed in the Ebbinghaus illusion, regardless of the size of the surrounding context circles [@girgus1972interrelationship]. 

However, varying stimulus features does not always produce consistent results in terms of the perceived illusion. For instance, there have been mixed findings regarding whether adding more small surrounding circles increases or decreases the perceived size of the target circle in the Ebbinghaus illusion [@massaro1971judgmental; @jaeger1978ebbinghaus], and each of these has been taken as support for competing theories [@jaeger2015ebbinghaus]. 

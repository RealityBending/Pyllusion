...
def _ebbinghaus_psychopy(window, parameters=None, target_only=False, **kwargs):
...
def _ebbinghaus_psychopy_draw(
    window, p, side="Left", color_inner="red", color_outer="black", target_only=False
):

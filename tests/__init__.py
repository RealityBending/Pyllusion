...
def test_mullerlyer():
    ...
    assert list(parameters1) == [
        ...
        "Size_Larger",
        "Size_Smaller",
        "Distractor_TopLeft1_x1",
        "Distractor_TopLeft1_y1",
        "Distractor_TopLeft1_x2",
        "Distractor_TopLeft1_y2",
        "Distractor_TopLeft2_x1",
        "Distractor_TopLeft2_y1",
        "Distractor_TopLeft2_x2",
        "Distractor_TopLeft2_y2",
        "Distractor_TopRight1_x1",
        "Distractor_TopRight1_y1",
        "Distractor_TopRight1_x2",
        "Distractor_TopRight1_y2",
        "Distractor_TopRight2_x1",
        "Distractor_TopRight2_y1",
        "Distractor_TopRight2_x2",
        "Distractor_TopRight2_y2",
        "Distractor_BottomLeft1_x1",
        "Distractor_BottomLeft1_y1",
        "Distractor_BottomLeft1_x2",
        "Distractor_BottomLeft1_y2",
        "Distractor_BottomLeft2_x1",
        "Distractor_BottomLeft2_y1",
        "Distractor_BottomLeft2_x2",
        "Distractor_BottomLeft2_y2",
        "Distractor_BottomRight1_x1",
        "Distractor_BottomRight1_y1",
        "Distractor_BottomRight1_x2",
        "Distractor_BottomRight1_y2",
        "Distractor_BottomRight2_x1",
        "Distractor_BottomRight2_y1",
        "Distractor_BottomRight2_x2",
        "Distractor_BottomRight2_y2",
        "Illusion",
        "Illusion_Strength",
        "Illusion_Type",
        "Distractor_Length",
...
def test_zollner():
    ...
    assert list(parameters1) == [
        ...
        "Distractors_Top_x2",
        "Distractors_Top_y2",
        "Distractors_Bottom_x1",
        "Distractors_Bottom_y1",
        "Distractors_Bottom_x2",
        "Distractors_Bottom_y2",
        "Distractors_Angle",
    ]
